            ...
            <div className='flex flex-col items-stretch mt-5'>
              ...
              >
                ...
                <div className='grow flex flex-col pl-5 pt-2'>
                  <div className='font-bold text-sm md:text-lg lg:text-xl group-hover:underline'>Home Page</div>
              ...
              >
                ...
                <div className='grow flex flex-col pl-5 pt-2'>
                  <div className='font-bold text-sm md:text-lg lg:text-xl group-hover:underline'>Help</div>
              ...
              >
                ...
                <div className='grow flex flex-col pl-5 pt-2'>
                  <div className='font-bold text-sm md:text-lg lg:text-xl group-hover:underline'>Contact</div>
